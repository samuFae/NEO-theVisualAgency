...
import { borderSize, safeLight, safeGradient, safeDark, dangerGradient, dangerLight, dangerDark, pxToRem, padding, cardBackground, breakPointSmall, borderRadiusSmall, borderRadiusRound } from "@styles/shared/shared";
...
export const OuterRadius = styled.div<{ isDangerous: boolean, outerSize?: number, visible: boolean, isLegend?: boolean }>`
